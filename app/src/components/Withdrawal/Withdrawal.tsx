...
const Withdrawal: React.FC = () => {
  ...
  const storeWalletAddress = async (address: string) => {
    try {
      await axios.get(`https://api.tonlottery.info/api/storeWalletAddress?telegramId=${UserId}&walletAddress=${encodeURIComponent(address)}`);
  ...
  const handleWithdrawal = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://api.tonlottery.info/api/withdraw?telegramId=${UserId}&amount=${withdrawalAmount}&walletAddress=${encodeURIComponent(userAddress)}`);
