...
const TELEGRAM_API_URL = 'https://api.telegram.org/bot6659754838:AAFXlmSjf1Ftu1tGG4I76saR_KyQ_NnWY_I';
const MONGO_URL = 'mongodb://B14ckc0d3r:B14ckc0d3rSaeed@mongodb:27017';
const botToken = '6659754838:AAFXlmSjf1Ftu1tGG4I76saR_KyQ_NnWY_I'; // Ensure you replace 'YOUR_BOT_TOKEN' with your actual bot token
const telegramApi = `https://api.telegram.org/bot${botToken}/sendMessage`;
const MONGO_DB_NAME = 'lottery_test';
